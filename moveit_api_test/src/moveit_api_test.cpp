...
int main(int argc, char **argv)
{
    ...
    */
    ...
    while (ros::ok())
    {
        ...
        fixedPose.position.x    = positionx[poseIndex];
        fixedPose.position.y    = positiony[poseIndex];
        fixedPose.position.z    = positionz[poseIndex];
        fixedPose.orientation.x = quatx[poseIndex];
        fixedPose.orientation.y = quaty[poseIndex];
        fixedPose.orientation.z = quatz[poseIndex];
        fixedPose.orientation.w = quatw[poseIndex];
        if (++poseIndex>15)
            poseIndex= 0;
        ...
        */
        ...
        if(success)
        {
            ...
            ROS_INFO("Failure is my destiny");
        r.sleep();
    }
}
